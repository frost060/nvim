...
_G.packer_plugins = {
  ...
  ["lsp_signature.nvim"] = {
    loaded = true,
    path = "/Users/barometer/.local/share/nvim/site/pack/packer/start/lsp_signature.nvim",
  ...
  ["nvim-navic"] = {
    loaded = true,
    path = "/Users/barometer/.local/share/nvim/site/pack/packer/start/nvim-navic",
